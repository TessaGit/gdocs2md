...
## Usage
  ...
  * Adding this script to your doc (once per doc):
    ...
    * Clear the myFunction() default empty function (your new project shou be blank
    * Paste the contents of [converttomarkdown.gapps](https://raw.github.com/mangini/gdocs2md/master/converttomarkdown.gapps) into the code editor
    * File -> Save
